...
const EGClient = require('epicgames-client').Client;
                  ...
                  const { email, password, bannerlevel, banner, bannercolor, YourAccountName, Features, Cosmetics, ApiDown } = require("../config.json");
                  const backupnetcl = require("./netcl.json");
                  if(!YourAccountName){
